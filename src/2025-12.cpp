...
void picture_alignment( const std::string& p_name = "g20.tex" ) {
    WITH_DOCUMENT( doc, OUT_DIR, FONT_PATH, COLOR_PATH, MACRO_PATH ) {
...
void alignment_graph_picture(
    ...
    WITH_DOCUMENT( doc, OUT_DIR, FONT_PATH, COLOR_PATH, MACRO_PATH ) {
        WITH_PICTURE( p1, { OPT::YSCALE( ".93" ) }, doc ) {
        ...
        WITH_PICTURE( p2, { OPT::YSCALE( ".93" ) }, doc ) {
        ...
        WITH_PICTURE( p3, { OPT::YSCALE( ".93" ) }, doc ) {
            place_string(
                p3, stylized_string{ "T\\position{t}", fragmentco{ 0, 1 }, str_displ_t ::NAME },
        ...
        WITH_PICTURE( p4, { OPT::YSCALE( ".93" ) }, doc ) {
            place_string(
                p4, stylized_string{ "T\\position{t}", fragmentco{ 0, 1 }, str_displ_t ::NAME },
                tikz_point{ .5 * CHAR_WIDTH, CHAR_HEIGHT + .4 } );
            place_string_vertical(
...
void slices_picture( const std::string& p_name = "g23.tex", stylized_string p_Pname = P_NAME,
    ...
    WITH_DOCUMENT( doc, OUT_DIR, FONT_PATH, COLOR_PATH, MACRO_PATH ) {
        ...
        WITH_PICTURE( p1, { OPT::YSCALE( ".9" ) }, doc ) {
        ...
        WITH_PICTURE( p2, { OPT::YSCALE( ".9" ) }, doc ) {
        ...
        WITH_PICTURE( p3, { OPT::YSCALE( ".9" ) }, doc ) {
        ...
        WITH_PICTURE( p4, { OPT::YSCALE( ".9" ) }, doc ) {
        ...
        WITH_PICTURE( p5, { OPT::YSCALE( ".9" ) }, doc ) {
        ...
        WITH_PICTURE( p6, { OPT::YSCALE( ".9" ) }, doc ) {
...
void picture_standard_trick( const std::string& p_name = "g01.tex", u64 p_n = 12, u64 p_m = 3,
    ...
    WITH_DOCUMENT( doc, OUT_DIR, FONT_PATH, COLOR_PATH, MACRO_PATH ) {
        ...
        for( u64 j = 0; j < p_n - p_m + p_k + 1; j += p_l ) {
            ...
            auto tn
                = stylized_string{ name, fragmentco{ j, std::min( p_n, j + p_m + p_l + p_k - 1 ) },
                                   str_displ_t::NAME };
...
void picture_structural_insight1( const std::string& p_name = "g11.tex",
    ...
    WITH_DOCUMENT( doc, OUT_DIR, FONT_PATH, COLOR_PATH, MACRO_PATH ) {
        ...
        add_occurrences_pictures( doc, pn, tn, occsre, p_style );
    }
}
...
void picture_structural_insight2( const std::string& p_name = "g12.tex",
    ...
    WITH_DOCUMENT( doc, OUT_DIR, FONT_PATH, COLOR_PATH, MACRO_PATH ) {
        ...
        add_occurrences_pictures( doc, pn, tn, occs, p_style );
    }
}
